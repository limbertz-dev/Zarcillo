...
export const READINGS_COLUMNS =
  "device_id, level, created_at, ambient_temperature, ambient_humidity, wine_temperature, light, ph, ph_voltage, accel_x, accel_y, accel_z, gyro_x, gyro_y, gyro_z, movement";
